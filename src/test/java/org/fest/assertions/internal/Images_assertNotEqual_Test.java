...
public class Images_assertNotEqual_Test {
  ...
  @Test public void should_pass_if_actual_is_null_and_expected_is_not() {
    images.assertNotEqual(TestData.someInfo(), null, TestData.fivePixelBlueImage());
  }

  @Test public void should_pass_if_expected_is_null_and_actual_is_not() {
    images.assertNotEqual(TestData.someInfo(), actual, null);
  }

  @Test public void should_pass_if_images_have_different_size() {
    images.assertNotEqual(TestData.someInfo(), actual, TestData.newImage(3, 3, BLUE));
  }

  @Test public void should_pass_if_images_have_different_color() {
    images.assertNotEqual(TestData.someInfo(), actual, TestData.fivePixelYellowImage());
  }

  @Test public void should_fail_if_images_are_equal() {
    AssertionInfo info = TestData.someInfo();
    BufferedImage other = TestData.newImage(5, 5, BLUE);
    try {
