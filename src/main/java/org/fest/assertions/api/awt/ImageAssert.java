...
public class ImageAssert extends AbstractAssert<ImageAssert, BufferedImage> {
  ...
  /**
   * Verifies that the actual image is equal to the given one. Two images are equal if: <ol> <li>they have equal size</li> <li>the
   * the RGB values of the color at each pixel are equal</li> </ol>
   *
  ...
  public ImageAssert isEqualTo(BufferedImage expected) {
    images.assertEqual(getInfo(), actual, expected);
    return this;
  }

  /**
   * Verifies that the actual image is equal to the given one. Two images are equal if: <ol> <li>they have the same size</li>
   * <li>the difference between the RGB values of the color at each pixel is less than or equal to the given offset</li> </ol>
   *
   * @param expected the given image to compare the actual image to.
   ...
   * have slightly different color values. For example, by using an offset of 1 we can indicate that a blue value of 60 is similar
   * to a blue value of 61.
   *
   * @return {@code this} assertion object.
   *
  ...
  public ImageAssert isEqualTo(BufferedImage expected, Offset<Integer> offset) {
    images.assertEqual(getInfo(), actual, expected, offset);
    return this;
  }
  ...
  public ImageAssert isNotEqualTo(BufferedImage other) {
    images.assertNotEqual(getInfo(), actual, other);
    return this;
  }
  ...
  public ImageAssert hasSize(Dimension expected) {
    images.assertHasSize(getInfo(), actual, expected);
    return this;
  }
